...
static const char *const yytname[] =
{
  ...
  "ADD", "SUB", "MUL", "DIV", "'('", "')'", "$accept", "expr", "term",
  "factor", YY_NULLPTR
};
...
#line 26 "cal.y"
                      { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); result = (yyval.fval); }
#line 1077 "cal.tab.c"
    break;
...
#line 1083 "cal.tab.c"
  ...
  case 4: /* expr: term  */
#line 28 "cal.y"
                      { (yyval.fval) = (yyvsp[0].fval); result = (yyval.fval); }
#line 1089 "cal.tab.c"
    break;
...
#line 1107 "cal.tab.c"
  ...
  case 8: /* factor: INT_NUM  */
#line 36 "cal.y"
                      { (yyval.fval) = (yyvsp[0].ival); }
#line 1113 "cal.tab.c"
    break;

  case 9: /* factor: FLOAT_NUM  */
#line 37 "cal.y"
                      { (yyval.fval) = (yyvsp[0].fval); }
#line 1119 "cal.tab.c"
    break;
